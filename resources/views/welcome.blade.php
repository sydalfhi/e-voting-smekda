                ...
                <div class="w-full md:w-1/2 md:px-3">
                    <div
                        ...
                        <h1
                            ...
                            <span class="block text-indigo-600 xl:inline" data-primary="indigo-600">Osis SMKN 2 Padang
                                Panjang</span>
                        </h1>
                        <p class="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">It's never been
                            Ayo! berpartisipasi melakukan voting untuk menentukan SMKN 2 Padang Panjang Kedepannya
                        </p>
