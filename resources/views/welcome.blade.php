...
<section class="relative px-2 bg-white pt-7 pb-14 md:px-0">
    <div class="container items-center max-w-6xl px-8 mx-auto xl:px-5">
        <div class="grid grid-cols-1 gap-10 lg:grid-cols-2 sm:-mx-3 place-items-center">
            <div class="text-center lg:text-left">
                <div class="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                    <h1 class="font-extrabold tracking-tight text-gray-900 text-3 xl sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                    ...
                    <div class="relative flex flex-col items-center justify-center xl:justify-start sm:flex-row sm:space-x-4">
                        <a href="/vote" class="flex items-center w-full px-20 py-3 mb-3 text-lg text-white bg-[#fd7014] rounded-md sm:mb-0 hover:bg-[#fd7014] sm:w-auto" data-primary="indigo-600" data-rounded="rounded-md">
                            Ayo Vote
            ...
            <div class="mt-6 lg:mt-0">
                <img src="{{ asset('assets/hero.jpg') }}" alt="hero" class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl ">
            </div>
        </div>
    </div>
</section>
